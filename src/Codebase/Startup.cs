using AutoMapper;
using Codebase.Features.Profiles;
...
namespace Codebase
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = _config.GetValue<string>("ASPNETCORE_Codebase_ConnectionString") ??
            ...
            var databaseProvider = _config.GetValue<string>("ASPNETCORE_Codebase_DatabaseProvider");
            if (string.IsNullOrWhiteSpace(databaseProvider))
                databaseProvider = DEFAULT_DATABASE_PROVIDER;

            services.AddDbContext<CodebaseContext>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory)
        {
            ...
            app.ApplicationServices.GetRequiredService<CodebaseContext>().Database.EnsureCreated();
        }
    }
}