...
namespace Codebase.Infrastructure
{
    public class CodebaseContext : DbContext
    {
        ...
        public CodebaseContext(DbContextOptions options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FollowedPeople>(b =>
            {
                ...
                // app.ApplicationServices.GetRequiredService<CodebaseContext>().Database.EnsureCreated(); throws the following error:
