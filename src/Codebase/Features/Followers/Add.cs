...
namespace Codebase.Features.Followers
{
    public class Add
    {
        ...
        public class QueryHandler : IRequestHandler<Command, ProfileEnvelope>
        {
            ...
            public QueryHandler(CodebaseContext context, ICurrentUserAccessor currentUserAccessor, IProfileReader profileReader)
            {
                _context = context;
